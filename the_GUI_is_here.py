...
def add_product_menu():
	...
	add_frame = tk.Frame(root, bg = framecolor)
	add_frame.place(relx = 0, rely = 0, relwidth = 1, relheight = 1) 
	label1 = tk.Label(add_frame, text = 'Enter Product Code : ', bg = framecolor )
	label1.place(relx = 0.15, rely = 0.1, relwidth = 0.3, relheight = 0.05)
	label2 = tk.Label(add_frame, text = 'Enter Product Name : ', bg = framecolor )
	label2.place(relx = 0.15, rely = 0.2, relwidth = 0.3, relheight = 0.05)
	label3 = tk.Label(add_frame, text = 'Enter Product Price : ', bg = framecolor )
	label3.place(relx = 0.15, rely = 0.3, relwidth = 0.3, relheight = 0.05)
	label4 = tk.Label(add_frame, text = 'Enter Category : ', bg = framecolor )
...
def add_product(entry1, entry2, entry3, entry4, add_frame):
	if entry1.get() and entry2.get() and entry3.get() and entry4.get():
		...
		if product_code not in products.keys() and product_code != 'none' and product_price != 'none':
			...
			entry3.delete(0, 'end')
			entry4.delete(0, 'end')
			label = tk.Label(add_frame, bg = framecolor)
...
def view_product():
	...
	view_frame = tk.Frame(root, bg = framecolor) 
...
def search_product_menu():
	...
	#ask = eval(input('Enter the product code you want to search for '))
		...
		label = tk.Label(frame, text = 'Enter Product Code : ', bg = framecolor )
...
def product_search(entry, frame):
	...
	if found:
		...
		label2 = tk.Label(frame, bg = framecolor )
		label2.place(relx = 0.05, rely = 0.5, relwidth = 0.22, relheight = 0.08)
		label3 = tk.Label(frame, bg = framecolor )
		label3.place(relx = 0.23, rely = 0.5, relwidth = 0.3, relheight = 0.08)
		label4 = tk.Label(frame, bg = framecolor )
		label4.place(relx = 0.5, rely = 0.5, relwidth = 0.22, relheight = 0.08)
		label5 = tk.Label(frame, bg = framecolor )
		label5.place(relx = 0.7, rely = 0.5, relwidth = 0.24, relheight = 0.08)
		label6 = tk.Label(frame, bg = framecolor )
		label6.place(relx = 0.05, rely = 0.6, relwidth = 0.22, relheight = 0.08)
		label7 = tk.Label(frame, bg = framecolor )
		label7.place(relx = 0.23, rely = 0.6, relwidth = 0.3, relheight = 0.08)
		label8 = tk.Label(frame, bg = framecolor )
		label8.place(relx = 0.5, rely = 0.6, relwidth = 0.22, relheight = 0.08)
		label9 = tk.Label(frame, bg = framecolor )
		label9.place(relx = 0.7, rely = 0.6, relwidth = 0.24, relheight = 0.08)
		entry.delete(0, 'end') 
...
def edit_product_frame2(entry, frame):
	...
	if found:
		...
		label1 = tk.Label(frame, text = 'Enter New Name : ', bg = framecolor )
		label1.place(relx = 0.03, rely = 0.4, relwidth = 0.3, relheight = 0.05)
		label2 = tk.Label(frame, text = 'Enter New Price : ', bg = framecolor )
		label2.place(relx = 0.03, rely = 0.5, relwidth = 0.3, relheight = 0.05)
		label3 = tk.Label(frame, text = 'Enter New Category : ', bg = framecolor )
		...
		label = tk.Label(frame, bg = framecolor)
...
def delete_product_menu():
    ...
    #ask = eval(input('Enter the product code you want to search for '))
        ...
        label = tk.Label(frame, text = 'Enter Product : ', bg = framecolor )
        label.place(relx = 0.15, rely = 0.2, relwidth = 0.3, relheight = 0.05)
        entry = tk.Entry(frame, bg = buttoncolor)
        entry.place(relx = 0.4, rely = 0.2, relwidth = 0.3, relheight = 0.05)
...
def product_menu():
	...
	button6 = tk.Button(frame, text = 'Go Back', bg = buttoncolor, fg = foregroundcolor, activebackground = activebackcolor, activeforeground = activeforcolor, command = mainframe)
	button6.place(relx = 0.36, rely = 0.7, relwidth = 0.3, relheight = 0.08) 

	label = tk.Label(frame, text ='          COMSATS CASH AND CARRY          ', bg = displaycolor )
	label.pack()
...
def add_customer_menu():
	...
	add_frame = tk.Frame(root, bg = framecolor)
	add_frame.place(relx = 0, rely = 0, relwidth = 1, relheight = 1) 
	label1 = tk.Label(add_frame, text = 'Enter Customer ID : ', bg = framecolor )
	label1.place(relx = 0.15, rely = 0.1, relwidth = 0.3, relheight = 0.05)
	label2 = tk.Label(add_frame, text = 'Enter Customer Name : ', bg = framecolor )
	label2.place(relx = 0.15, rely = 0.2, relwidth = 0.3, relheight = 0.05)
	label3 = tk.Label(add_frame, text = 'Enter Phone no. : ', bg = framecolor )
	label3.place(relx = 0.15, rely = 0.3, relwidth = 0.3, relheight = 0.05)
	label4 = tk.Label(add_frame, text = 'Enter Address : ', bg = framecolor )
	label4.place(relx = 0.15, rely = 0.4, relwidth = 0.3, relheight = 0.05)
	...
	button_add = tk.Button(add_frame, text = 'ADD', bg = buttoncolor, fg = foregroundcolor, activebackground = activebackcolor, activeforeground = activeforcolor, command = lambda : add_customer(entry1, entry2, entry3, entry4, add_frame))
	button_add.place(relx = 0.2, rely = 0.7, relwidth = 0.3, relheight = 0.08) 
...
def add_customer(entry1, entry2, entry3, entry4, add_frame):
	if entry1.get() and entry2.get() and entry3.get() and entry4.get():
...
def view_customer():
	...
	if customers:
		...
		label3.place(relx = 0.5, rely = 0.2, relwidth = 0.22, relheight = 0.08)
		label4 = tk.Label(view_frame, text = 'Address', bg = displaycolor )
		label4.place(relx = 0.7, rely = 0.2, relwidth = 0.24, relheight = 0.08)
		print('Customer Code\t\t\t name\t\t\tphoneno\t\t\tAddress')
...
def search_customer_menu():
	...
	#ask = eval(input('Enter the product code you want to search for '))
		...
		label = tk.Label(frame, text = 'Enter Customer ID: ', bg = framecolor )
		label.place(relx = 0.15, rely = 0.2, relwidth = 0.3, relheight = 0.05)
		entry = tk.Entry(frame, bg = buttoncolor)
		entry.place(relx = 0.4, rely = 0.2, relwidth = 0.3, relheight = 0.05)
...
def edit_customer_menu():
    ...
    #ask = eval(input('Enter the customer code you want to search for '))
        ...
        label = tk.Label(frame, text = 'Enter Customer Code : ', bg = framecolor )
        label.place(relx = 0.03, rely = 0.2, relwidth = 0.3, relheight = 0.05)
        entry = tk.Entry(frame, bg = buttoncolor)
        entry.place(relx = 0.28, rely = 0.2, relwidth = 0.3, relheight = 0.05)
...
def delete_customer_menu():
	...
	#ask = eval(input('Enter the product code you want to search for '))
		...
		label = tk.Label(frame, text = 'Enter Customer : ', bg = framecolor )
		label.place(relx = 0.15, rely = 0.2, relwidth = 0.3, relheight = 0.05)
		entry = tk.Entry(frame, bg = buttoncolor)
		entry.place(relx = 0.4, rely = 0.2, relwidth = 0.3, relheight = 0.05)
...
def add_sales_menu():
	...
	button_go_back = tk.Button(frame, text = 'GO BACK', bg = buttoncolor, fg = foregroundcolor, activebackground = activebackcolor, activeforeground = activeforcolor, command = mainframe)
...
def add_sales_frame2(entry, frame):
	...
	if customerid in customers.keys() :
		...
		label = tk.Label(frame, text = 'Enter Sales ID : ', bg = framecolor )
		label.place(relx = 0.03, rely = 0.4, relwidth = 0.3, relheight = 0.05)
		entry2 = tk.Entry(frame, bg = buttoncolor)
...
def add_sales_frame3(customerid, salesid, frame):
	...
	if salesid not in sales.keys() and salesid != 'none':
		newframe = tk.Frame(root, bg = framecolor)
		newframe.place(relx = 0, rely = 0, relheight = 1, relwidth = 1)

		label = tk.Label(newframe, text = 'Enter Product ID', bg = framecolor)
		label.place(relx = 0.1, rely = 0.3, relwidth = 0.3, relheight = 0.05)
		label = tk.Label(newframe, text = 'Enter Quantity', bg = framecolor)
...
def add_sale(salesid, customerid, productdict):
	...
	new_frame = tk.Frame(root, bg = framecolor)
...
def view_sale():
	...
	if sales:
		...
		label = tk.Label(frame, text = 'Wadood Jamal and Sons C&C', bg = displaycolor)
...
def sale_menu():
	...
	button3 = tk.Button(frame, text = 'Go Back', bg = buttoncolor, fg = foregroundcolor, activebackground = activebackcolor, activeforeground = activeforcolor, command = mainframe)
	button3.place(relx = 0.36, rely = 0.4, relwidth = 0.3, relheight = 0.08) 
